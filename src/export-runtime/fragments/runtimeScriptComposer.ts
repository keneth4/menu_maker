...
export type BuildRuntimeScriptOptions = {
  ...
  minBackgroundCarouselSeconds: number;
  maxBackgroundCarouselSeconds: number;
  instructionCopy: Record<string, Record<string, string>>;
};

export const buildRuntimeScript = (data: MenuProject, options: BuildRuntimeScriptOptions) => {
  const {
...
${buildRuntimeImageSourcesFragment()}
